...
#SECRET_KEY = 'django-insecure-d6s=8d544k21^po+r__uwn7vk4_^cziyh%-qog70rg5gv2c+35'
...
# Configurar DRF para usar JWT
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'usuarios.api.v1.authentication.CookieJWTAuthentication',
    ),
}
